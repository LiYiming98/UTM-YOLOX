...
from nets.yolo_training_open import (ModelEMA, YOLOLoss, get_lr_scheduler,
...
#     model_path = '../../autodl-tmp/logs/ep025-loss5.701-val_loss5.518.pth'
    # ------------------------------------------------------#
...
#     weight_decay = 0
    ...
    #   获得图片路径和标签
    # ----------------------------------------------------#
    train_annotation_path = '2007_train_new_aug_2_open_delete.txt'
    val_annotation_path = '2007_test_open_delete.txt'
