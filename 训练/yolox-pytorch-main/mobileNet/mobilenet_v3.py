...
class MobileNetV3(nn.Module):
    def __init__(self, num_classes=1000, width_mult=1.):
        ...
        self.cfgs = [
            ...
            [5, 3, 40, 1, 0, 2],
            [5, 3, 40, 1, 0, 1],
            [5, 3, 40, 1, 0, 1], # out3: self.model.features[:7],0-6层网络的输出
            [3, 6, 80, 0, 1, 2],
            [3, 2.5, 80, 0, 1, 1],
            [3, 2.3, 80, 0, 1, 1],
            [3, 2.3, 80, 0, 1, 1],
            [3, 6, 112, 1, 1, 1],
            [3, 6, 112, 1, 1, 1],  # out4 : self.model.features[7:13](out3) 7-12层网络的输出
            [5, 6, 160, 1, 1, 2],
            [5, 6, 160, 1, 1, 1],
            [5, 6, 160, 1, 1, 1]]  # out5 = self.model.features[13:16](out4) 12-15层网络的输出
