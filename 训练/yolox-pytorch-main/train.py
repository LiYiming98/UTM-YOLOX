...
from nets.yolo_yuanshi_dfl import YoloBody_yuanshi_dfl 
from MobileNet_small_Nets.yolo_mobileNetV3_small_dfl import YoloBody   # mobileNet-small-dfl
from MobileNet_small_Nets.yolo_training_ld_confidence import YOLOLoss,weights_init   # ld

from nets.yolo_training import (ModelEMA, YOLOLoss, get_lr_scheduler,
                                set_optimizer_lr, weights_init)
from utils.callbacks_close import EvalCallback, LossHistory
from utils.dataloader import YoloDataset, yolo_dataset_collate
from utils.utils import (get_classes, seed_everything, show_config,
                         worker_init_fn)
from utils.utils_fit import fit_one_epoch_lcp
# from MobileNet_small_Nets.utils_fit import fit_one_epoch_l_c_p
...
if __name__ == "__main__":
    ...
    #   获得图片路径和标签
    #----------------------------------------------------#
    train_annotation_path   = '2007_train_new_aug_2_close_half.txt'
    val_annotation_path     = '2007_test_close_half.txt'
    ...
    # 加载教师模型的权重：
    teacher_model_path = 'logs/kd/ep190-loss2.556-val_loss6.196.pth'
    device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')
    ...
    if True:
        ...
        for epoch in range(Init_Epoch, UnFreeze_Epoch):
            ...
            fit_one_epoch_lcp(model_train, model,teacher_model, ema, yolo_loss, loss_history, eval_callback, optimizer, epoch, epoch_step, epoch_step_val, gen, gen_val, UnFreeze_Epoch, Cuda, fp16, scaler, save_period, save_dir, local_rank)
