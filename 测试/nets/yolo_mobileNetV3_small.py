    ...
    def __init__(self, num_classes, width=1.0, in_channels=[128, 256, 512], act="silu", depthwise=False):
        ...
        for i in range(len(in_channels)):
            ...
            self.reg_preds.append(
                nn.Conv2d(in_channels=int(128 * width), out_channels=4, kernel_size=1, stride=1, padding=0)
            )
...
#     classes_path = 'D:/mogaidaima/feature_imitation/yolox-pytorch-main-mobilenet/model_data/minisar_classes.txt'
#     class_names, num_classes = get_classes(classes_path)
#     module = YoloBody(num_classes, "s")
